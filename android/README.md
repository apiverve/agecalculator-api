...
```gradle
dependencies {
    implementation 'com.github.apiverve:agecalculator-api:1.1.13'
}
```
...
```java
import com.apiverve.agecalculator.AgeCalculatorAPIClient;
import com.apiverve.agecalculator.APIResponse;
import com.apiverve.agecalculator.APIException;

// Initialize the client
AgeCalculatorAPIClient client = new AgeCalculatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("dob", "1990-08-02");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/agecalculator](https://docs.apiverve.com/ref/agecalculator)
...
- **Documentation:** [https://docs.apiverve.com/ref/agecalculator](https://docs.apiverve.com/ref/agecalculator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/agecalculator-api/issues)
