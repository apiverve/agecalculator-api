...
namespace APIVerve\Agecalculator;
...
/**
 * Client for the Age Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/agecalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/agecalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\AgecalculatorClient] {$message}\n";
        }
    }
}
