// Package agecalculator provides a Go client for the Age Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/agecalculator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Age Calculator API.
//
// Parameters:
//   - dob (required): string - The date of birth to calculate the age from (format: YYYY-MM-DD) [format: date]
type Request struct {
...
// ResponseData contains the data returned by the Age Calculator API.
type ResponseData struct {
	...
	AgeWords AgeWordsData `json:"age_words"`
}

// AgeWordsData represents the age_words object.
type AgeWordsData struct {
