...
const (
	baseURL        = "https://api.apiverve.com/v1/agecalculator"
	defaultTimeout = 30 * time.Second
)

// Client is the Age Calculator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Age Calculator API client.
...
// Execute makes a request to the Age Calculator API with typed parameters.
//
