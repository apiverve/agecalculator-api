...
class agecalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/agecalculator');
        }
        ...
        this.validationRules = {"dob":{"type":"string","required":true,"format":"date"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/agecalculator`);
        }
    }
...
module.exports = agecalculatorWrapper;
